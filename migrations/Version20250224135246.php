 ...
 */
final class Version20250224135246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orga_info (id INT AUTO_INCREMENT NOT NULL, logo VARCHAR(255) DEFAULT NULL, orga_siret VARCHAR(14) NOT NULL, org_status VARCHAR(255) NOT NULL, proc_title VARCHAR(255) DEFAULT NULL, proc_ref VARCHAR(255) DEFAULT NULL, org_emp INT DEFAULT 0 NOT NULL, org_cat_act JSON NOT NULL, org_cert JSON NOT NULL, org_sub_do TINYINT(1) NOT NULL, org_sub_use TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_5691D4F3F7CF3C66 (orga_siret), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
